...
const Header = () => {
    ...
    return (
        <header className='w-full bg-[#0E0E0E] text-white fixed z-50'>
            <div className="custom-container flex justify-between items-center py-5">
                <div className="">
                    <h1 className='text-2xl font-semibold'>ALTAIR</h1>
                </div>
                <nav className={`${openModal ? "block" : "max-md:hidden"} block max-md:fixed max-md:top-16 max-md:left-0 max-md:h-screen max-md:w-full max-md:bg-[#0E0E0E] max-lg:z-[-1]`}>
